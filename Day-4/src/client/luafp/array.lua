...
function array.slice(startIndex, endIndex, list)
    local values = {}
    for key, value in pairs({table.unpack(list, startIndex, endIndex)}) do
        table.insert(values, value)
    end
    return values
end

array.indexOf = func.curry(array.indexOf, 3)
array.findIndex = func.curry(array.findIndex, 3)
array.find = func.curry(array.find, 3)
array.difference2 = func.curry(array.difference2, 2)
array.fill = func.curry(array.fill, 4)
array.slice = func.curry(array.slice, 3)
